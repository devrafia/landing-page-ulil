                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select" id="author_id" name="author_id" style="width: 100%;"
                                                data-placeholder="Choose Author" required>
                                                <option value="">Choose Category</option>
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label" for="example-maxlength4">Title <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="js-maxlength form-control" id="example-maxlength4"
                                                name="title" maxlength="160" minlength="35" placeholder="At a minimum 35"
                                                data-always-show="true" data-pre-text="Used " data-separator=" of "
                                                data-post-text=" characters" required value="{{ old('title') }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="file"
                                                ...
                                                name="feature_image" id="feature_image" required>
                                            <span class="help-block with-errors"></span>
                                            <small>Feature Image <b> cannot more than 1mb </b>, with format : jpeg,jpg,png.
                                                <span class="text-danger"> <b>Size 750x433</b> </span></small>
                                            <br>
                                            <small>Feature Image names are <span class="text-danger"><b>prohibited
                                                    </b></span> using <b>
                                                    #,%,\,/,?
                                                </b></small>
